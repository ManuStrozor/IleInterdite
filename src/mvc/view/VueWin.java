...
public class VueWin extends Vue {

    private JButton  quitter;

    public VueWin(String name, IHM ihm, int width, int height) {
    ...
    public void initComponents() {
        this.setBackground(new ImageIcon(Objects.requireNonNull(getClass().getClassLoader().getResource("win.jpg"))).getImage());
        ...
        JLabel perdu = new JLabel("Bravo , vous avez gagné ", SwingConstants.CENTER);
